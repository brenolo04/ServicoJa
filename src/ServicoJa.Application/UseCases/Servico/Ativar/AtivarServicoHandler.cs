...
namespace ServicoJa.Application.UseCases.Servico.Ativar;

public class AtivarServicoHandler
{
    private readonly IServicoRepository _servicoRepository;

    public AtivarServicoHandler(IServicoRepository servicoRepository)
    {
